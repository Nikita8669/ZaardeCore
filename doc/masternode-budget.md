...
Zaarde now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<zaarde_address\> \<monthly_payment_zaarde\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Zaarde, _12_ times over the course of a year totaling _24000_ Zaarde.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<zaarde_address\> \<monthly_payment_zaarde\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` Zaarde.
