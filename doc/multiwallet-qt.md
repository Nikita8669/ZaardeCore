...
In order to support loading of multiple wallets in zaarde-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zaarde.cpp.
...
Changes to zaarde.cpp
----------------------
zaarde.cpp is the entry point into zaarde-qt, and as such, will require some minor modifications to provide hooks for
