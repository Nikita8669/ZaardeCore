...
* WebSocket: [https://github.com/zaardeproject/insight-api-zaarde#web-socket-api](https://github.com/zaardeproject/insight-api-zaarde#web-socket-api) 
* API: [https://github.com/zaardeproject/insight-api-zaarde#swifttx-transactions](https://github.com/zaardeproject/insight-api-zaarde#swifttx-transactions) 
...
By default, the Zaarde Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zaarde Core daemon:
