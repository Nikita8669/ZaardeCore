...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of
        (0, uint256("00000fc1434d55246f1ad3c4d5d9ec933dc15f1f664f9d14ba8d129215fb3476"))
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Zaarde: 1 day
        nTargetSpacing = 1 * 60;  // Zaarde: 1 minute
        nMaturity = 30;
        ...
        const char* pszTimestamp = "Zaarde is here - 22 October 2019 - Nikita - Remapper";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1571322867;
        genesis.nBits = 0x1e0ffff0; // 504365040
        genesis.nNonce = 1771156;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000fc1434d55246f1ad3c4d5d9ec933dc15f1f664f9d14ba8d129215fb3476"));
        assert(genesis.hashMerkleRoot == uint256("0x1298b1f281542dfb41e17c74c7516734aa750dbaab2578af9f0e307ef9b900b1"));

        vSeeds.push_back(CDNSSeedData("45.63.101.244", "45.63.101.244")); // Team1
        vSeeds.push_back(CDNSSeedData("45.63.99.235", "45.63.99.235"));   // Team2
        vSeeds.push_back(CDNSSeedData("45.63.99.70", "45.63.99.70"));     // Team3
        vSeeds.push_back(CDNSSeedData("159.65.93.87", "159.65.93.87"));   //Remapper
		//Extras
		vSeeds.push_back(CDNSSeedData("80.211.61.135", "80.211.61.135"));
		vSeeds.push_back(CDNSSeedData("80.211.115.118", "80.211.115.118"));
		vSeeds.push_back(CDNSSeedData("80.211.202.182", "80.211.202.182"));
		vSeeds.push_back(CDNSSeedData("80.211.114.41", "80.211.114.41"));
		vSeeds.push_back(CDNSSeedData("195.181.211.145", "195.181.211.145"));
		vSeeds.push_back(CDNSSeedData("80.211.27.240", "80.211.27.240"));
        ...
        strObfuscationPoolDummyAddress = "ZHWsgRktTRDj5CPjWts4hJsvzwmNPbvZY8";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Zaarde: 1 day
        nTargetSpacing = 1 * 10;  // Zaarde: 1 minute
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet zaarde addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet zaarde script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet zaarde BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet zaarde BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet zaarde BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Zaarde: 1 day
        nTargetSpacing = 1 * 60;        // Zaarde: 1 minutes
