...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemazaardeGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemazaardeGrant grantOutbound;
