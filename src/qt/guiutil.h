...
/** Utility functions used by the Zaarde Qt UI.
 */
namespace GUIUtil
{
...
// Render Zaarde addresses in monospace font
...
// Parse "zaarde:" URI into recipient object, return true on successful parsing
