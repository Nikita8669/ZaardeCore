...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(ZARD);
    unitlist.append(mZARD);
    unitlist.append(uZARD);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case ZARD:
        return QString("zaarde");
    case mZARD:
        return QString("mzaarde");
    case uZARD:
        return QString::fromUtf8("uzaarde");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ZARD:
            return QString("ZARD");
        case mZARD:
            return QString("mZARD");
        case uZARD:
            return QString::fromUtf8("μZARD");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case ZARD:
            return QString("tZARD");
        case mZARD:
            return QString("mtZARD");
        case uZARD:
            return QString::fromUtf8("μtZARD");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case ZARD:
            return QString("ZARD");
        case mZARD:
            return QString("Milli-ZARD (1 / 1" THIN_SP_UTF8 "000)");
        case uZARD:
            return QString("Micro-ZARD (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case ZARD:
            return QString("TestZARDs");
        case mZARD:
            return QString("Milli-TestZARD (1 / 1" THIN_SP_UTF8 "000)");
        case uZARD:
            return QString("Micro-TestZARD (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
