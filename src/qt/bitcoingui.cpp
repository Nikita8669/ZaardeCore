                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Zaarde Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zaarde address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zaarde: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zZARD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Zaarde Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zaarde Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zaarde"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zaarde addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zaarde addresses"));
    ...
    openAction->setStatusTip(tr("Open a Zaarde: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zaarde Core help message to get a list with possible Zaarde command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Zaarde Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zaarde network", "", count));
}
...
{
    QString strTitle = tr("Zaarde Core"); // default title
