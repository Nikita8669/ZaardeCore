...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Zaarde Core zaarde-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zaarde-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zaarde transaction") + "\n" +
                               "  zaarde-tx [options] -create [commands]   " + _("Create hex-encoded zaarde transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zaarde transaction
