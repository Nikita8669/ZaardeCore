...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zaarde features */
        {"zaarde", "masternode", &masternode, true, true, false},
        {"zaarde", "listmasternodes", &listmasternodes, true, true, false},
        {"zaarde", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"zaarde", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"zaarde", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"zaarde", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zaarde", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zaarde", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zaarde", "masternodedebug", &masternodedebug, true, true, false},
        {"zaarde", "startmasternode", &startmasternode, true, true, false},
        {"zaarde", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zaarde", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zaarde", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zaarde", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zaarde", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zaarde", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zaarde", "mnbudget", &mnbudget, true, true, false},
        {"zaarde", "preparebudget", &preparebudget, true, true, false},
        {"zaarde", "submitbudget", &submitbudget, true, true, false},
        {"zaarde", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zaarde", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zaarde", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zaarde", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zaarde", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zaarde", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zaarde", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zaarde", "checkbudgets", &checkbudgets, true, true, false},
        {"zaarde", "mnsync", &mnsync, true, true, false},
        {"zaarde", "spork", &spork, true, true, false},
        {"zaarde", "getpoolinfo", &getpoolinfo, true, true, false},
        {"zaarde", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
...
{
    return "> zaarde-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51999/\n";
}
